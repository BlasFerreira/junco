...
import torch
# BERT tokenizer and model for token classification
from transformers import BertTokenizer, BertForTokenClassification
from transformers import RobertaTokenizer, RobertaForQuestionAnswering
# BART model and tokenizer for conditional generation tasks (e.g., text summarization)
from transformers import BartForConditionalGeneration, BartTokenizer
# Pipeline to create easy-to-use interfaces with transformers
...
import nltk
# Generic tokenizer and model for sequence-to-sequence tasks
...
# A NER pipeline is set up, and entities from paragraphs are added to the entities list.
entities = []
...
# Delete duplicates
seen_words = set()
unique_data = [entry for entry in selected_entities if entry['word'] not in seen_words and not seen_words.add(entry['word'])]
...
inputs_summ = [tokenizer(chunk, return_tensors="pt") for chunk in chunks_summ]
...
# I divide the text into 8 chunks to be processed by the model
